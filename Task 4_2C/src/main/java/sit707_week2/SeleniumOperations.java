...
public class SeleniumOperations {
    ...
    public static void testValidLogin(WebDriver driver, String url) {
        ...
        usernameField.sendKeys("nima@gmail.com");
        passwordField.sendKeys("Thisarani@12345");
	...
	public static void testInvalidLogin(WebDriver driver, String url) {
        ...
        usernameField.sendKeys("thisarani123@gmail.com");
        passwordField.sendKeys("Thisarani@1234");
